...
class PetFriends:
    ...
    def add_new_pet(self, auth_key: json, age:int=3, animal_type: str='cat', name: str='Petya', pet_photo: str='tests/images/img1.jpg') -> json:
    ...
    def simple_create_new_pet(self, auth_key: json, name: str='Murlik', animal_type: str='zver', age: int=5) -> json:
